...
@section('title', "Beranda - {$school['NAMA_SEKOLAH']}")
            ...
            <div class="w-full lg:w-5/12 text-center lg:text-left space-y-6">
                ...
                <div
                    ...
                    <div
                        ...
                        <span class="text-3xl font-black">{{ $school['AKREDITASI_HURUF_SEKOLAH'] }}</span>
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
            ...
            <div class="w-full md:w-2/3">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-6">"{{ $school['MOTIVASI_KEPALA_SEKOLAH'] }}"</h2>
                <blockquote class="text-gray-600 mb-8 leading-relaxed italic border-l-4 border-teal-200 pl-4">
                    {{ $school['SAMBUTAN_KEPALA_SEKOLAH'] }}
                </blockquote>
                <div class="flex items-center gap-4">
                    <div>
                        <p class="text-xl font-black text-teal-900">{{ $school['KEPALA_SEKOLAH'] }}</p>
                        <p class="text-gray-500 text-sm">{{ $school['PRESTASI_KEPALA_SEKOLAH'] }}</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-teal-900 py-20 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <p class="text-teal-100 text-lg md:text-xl mb-10 font-light max-w-2xl mx-auto">
            Penerimaan Peserta Didik Baru (PPDB) Tahun Ajaran {{ $ppdbPeriod }} Segera Dibuka. Kuota terbatas!
        </p>
