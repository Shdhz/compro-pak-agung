    ...
    <div
        ...
        <div class="flex flex-wrap justify-center md:justify-start items-center gap-x-6 gap-y-1">
            <div class="flex items-center gap-2">
                ...
                <span>{{ $school['EMAIL_SEKOLAH'] }}</span>
            </div>
            <div class="flex items-center gap-2">
                <svg class="w-3.5 h-3.5 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex items-center space-x-4">
            <div class="flex items-center space-x-3">
                <a href="{{ $school['FACEBOOK_SEKOLAH'] }}" class="hover:text-yellow-400 transition flex items-center gap-1"><span
                        class="hidden sm:inline">Facebook</span><span class="sm:hidden">FB</span></a>
                <a href="{{ $school['INSTAGRAM_SEKOLAH'] }}" class="hover:text-yellow-400 transition flex items-center gap-1"><span
                        class="hidden sm:inline">Instagram</span><span class="sm:hidden">IG</span></a>
                <a href="{{ $school['YOUTUBE_SEKOLAH'] }}" class="hover:text-yellow-400 transition flex items-center gap-1"><span
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="font-bold text-xl leading-none">{{ $school['NAMA_SEKOLAH'] }}</h1>
                    <span class="text-xs text-teal-200 font-light">{{ $school['HEADLINE_SEKOLAH'] }}</span>
                </div>
            </div>
